      ...
      <div className='container mx-auto mb-24'>
        ...
        className='flex flex-col lg:flex-row lg:justify-between gap-x-5 gap-y-14'>
          <div className='flex flex-col flex-1 gap-y-8'>
            ...
            {/* text */}
            <div className='text-secondary'>Lorem ipsum dolor sit amet coneturer adipoisiing elit.</div>
            {/* phone and email */}
          ...
          <div className='flex-1'>
            ...
            <div className='flex flex-col gap-y-4'>
              ...
              <div className='flex gap-x-2'>
                <div className='text-secondary'>Suni:</div>
          ...
          {/* newsletter */}
          <div className='flex-1'>
            <h3 className='h3 font-bold mb-8'>Newletter</h3>
            <div className='mb-9 text-secondary'>Lorem ipsum dolor sit amet conseture adipising elit.</div>
            {/* form */}
