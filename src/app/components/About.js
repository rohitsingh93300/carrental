    ...
    <section className='section flex items-center' id='about' ref={ref}>
      <div className='container mx-auto'>
        <div className='flex flex-col xl:flex-row xl:justify-between'>
          ...
          {/* text and status */}
          <div className='flex-1 items-center flex xl:justify-center'>
              ...
              className='flex items-center gap-x-8 mb-12'>
                {/* car types */}
                  <div className='flex flex-col w-[100px]'>
                    ...
                    <div className='uppercase text-[13px] font-semibold text-secondary'>car <br/> types</div>
                  </div>
                {/* rental outlets */}
                  <div className='flex flex-col w-[100px]'>
                    ...
                    <div className='uppercase text-[13px] font-semibold text-secondary'>rental <br/> outlets</div>
                  </div>
                {/* repair points */}
                  <div className='flex flex-col w-[100px]'>
                    ...
                    <div className='uppercase text-[13px] font-semibold text-secondary'>repair <br/> points</div>
                  </div>
                  {/* btn */}
              </motion.div>
                  <motion.button 
